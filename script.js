...
const translations = {
  "en": {
    ...
    "nav.book": "Free Session",
    "hero.eyebrow": "Decision Coaching",
    "hero.title": "Find Your Direction In A World Full Of Options",
    "hero.lead": "Personalised coaching and practical tools to help you move from confusion to clarity, confidence and financial stability.",
    "hero.note": "You are only one step away from the solution you’re looking for!",
    "hero.book": "Book your session",
    ...
    "services.career.text": "Explore job changes, next steps, purpose, growth, and professional direction.",
    ...
    "process.move.text": "You leave with a clear next step.",
  ...
  "el": {
    ...
    "nav.book": "Δωρεάν Συνεδρία",
    "hero.eyebrow": "Coaching Αποφάσεων",
    "hero.title": "Βρες την Κατεύθυνσή σου σε έναν Κόσμο Γεμάτο Επιλογές",
    "hero.lead": "Εξατομικευμένο coaching και πρακτικά εργαλεία για να περάσεις από τη σύγχυση στη σαφήνεια, την αυτοπεποίθηση και την οικονομική σταθερότητα.",
    "hero.note": "Είσαι μόνο ένα βήμα μακριά από τη λύση που αναζητάς!",
    "hero.book": "Κλείσε συνεδρία",
    ...
    "services.career.text": "Εξερεύνησε αλλαγές εργασίας, επόμενα βήματα, σκοπό, εξέλιξη και επαγγελματική κατεύθυνση.",
    ...
    "process.move.text": "Φεύγεις με ένα ξεκάθαρο επόμενο βήμα.",
